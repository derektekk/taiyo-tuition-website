        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-12">
            ...
            <section className="bg-white rounded-2xl shadow-lg p-8" aria-labelledby="contact-info-heading">
              <ScrollAnimateText as="h2" id="contact-info-heading" className="text-3xl font-bold text-gray-900 mb-8 text-center">
                Get in Touch
              </ScrollAnimateText>
              <address className="space-y-6 not-italic">
                {contactInfo.map((info, index) => (
                  <div key={index} className="flex items-start space-x-4">
                    ...
                    <div>
                      <ScrollAnimateText as="h3" className="font-semibold text-gray-900 text-lg">
                        {info.title}
                      </ScrollAnimateText>
                      {info.title === 'Email' ? (
                        <ScrollAnimateText>
                        ...
                        <ScrollAnimateText as="p" className="text-blue-600 font-medium text-lg">
                          {info.details}
                        </ScrollAnimateText>
                      )}
                      <ScrollAnimateText as="p" className="text-gray-600">
                        {info.description}
                      </ScrollAnimateText>
                    </div>
                  </div>
            ...
            <section className="bg-blue-50 rounded-2xl shadow-lg p-8" aria-labelledby="cta-heading">
              <ScrollAnimateText as="h2" id="cta-heading" className="text-3xl font-bold text-gray-900 mb-4 text-center">
                Ready to Get Started?
              </ScrollAnimateText>
              <ScrollAnimateText as="p" className="text-xl text-gray-600 mb-8 text-center">
                Contact us today to discuss your academic goals and book your free trial lesson
              </ScrollAnimateText>
              <nav className="flex flex-col gap-4 justify-center items-center" aria-label="Contact actions">
                <ScrollAnimateText>
                  <a
          ...
          <aside>
            <section className="bg-white rounded-2xl shadow-lg p-8 h-fit" aria-labelledby="faq-heading">
              <ScrollAnimateText as="h2" id="faq-heading" className="text-3xl font-bold text-gray-900 mb-8 text-center">
                Quick Questions?
              </ScrollAnimateText>
              <div className="space-y-6">
                <div className="border-b border-gray-200 pb-6">
                  ...
                  <ScrollAnimateText className="text-gray-600">
                    Simply contact us directly via phone or email. We'll arrange a free trial lesson at your convenience and discuss your academic goals.
                  </ScrollAnimateText>
                </div>
                <div className="border-b border-gray-200 pb-6">
                  <ScrollAnimateText className="font-semibold text-gray-900 mb-3 text-lg">
                  ...
                  <ScrollAnimateText className="text-gray-700">
                    We offer tutoring in Mathematics, Physics, Chemistry, English, Biology, and History for VCE students. Visit our subjects page to learn more.
                  </ScrollAnimateText>
                </div>
                <div className="border-b border-gray-200 pb-6">
                  <ScrollAnimateText className="font-semibold text-gray-900 mb-3 text-lg">
                  ...
                  <ScrollAnimateText className="text-gray-600">
                    Yes! We offer both in-person and online tutoring sessions to accommodate your preferences and schedule.
                  </ScrollAnimateText>
                </div>
                <div className="border-b border-gray-200 pb-6">
                  <ScrollAnimateText className="font-semibold text-gray-900 mb-3 text-lg">
                  ...
                  <ScrollAnimateText className="text-gray-600">
                    Taiyo Tuition guarantees a 45+ Study Score, or your money back. With a cap of 10 students per tutorial, we provide personalized attention for optimal results.
                  </ScrollAnimateText>
                </div>
                <div>
                  <ScrollAnimateText className="font-semibold text-gray-900 mb-3 text-lg">
                  ...
                  <ScrollAnimateText className="text-gray-600">
                    Our pricing varies depending on the subject and class format. Contact us directly for detailed pricing information and package options.
                  </ScrollAnimateText>
                </div>
              </div>
            </section>
