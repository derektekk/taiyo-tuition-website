...
const Atar = () => {
    const atarResults = [
        { score: "98.95", name: "Emma", school: "Haileybury" },
        { score: "99.75", name: "Oliver", school: "Scotch" },
        { score: "99.75", name: "Serena", school: "Mac.Rob" },
        { score: "99.75", name: "Daniel", school: "PEGs" },
        { score: "99.75", name: "Undisclosed", school: "Suzanne Cory" },
        { score: "99.70", name: "Aarav", school: "Haileybury" },
        { score: "99.70", name: "Elise", school: "Mac.Rob" },
        { score: "99.65", name: "Tahlia", school: "Lowther Hall" },
        { score: "99.65", name: "Zachary", school: "MHS" },
        { score: "99.65", name: "Lucas", school: "Suzanne Cory" },
        { score: "99.65", name: "Undisclosed", school: "JMSS" },
        { score: "98.60", name: "Isabella", school: "Strathcona" },
        { score: "98.80", name: "Hannah", school: "Haileybury" },
        { score: "98.60", name: "Jayden", school: "MHS" },
        { score: "97.60", name: "Nikhil", school: "Nossal" },
        { score: "97.55", name: "Sienna", school: "Mac.Rob" },
        { score: "97.50", name: "Kieran", school: "Caulfield GS" },
        { score: "97.45", name: "Thomas", school: "MHS" },
    ];
    ...
    React.useEffect(() => {
        ...
        const interval = setInterval(() => {
            setCurrentIndex((prevIndex) =>
                prevIndex + resultsPerPage >= atarResults.length
                    ? 0
                    : prevIndex + resultsPerPage
            );
        }, 10000);
    ...
    const handlePrevious = () => {
        ...
        setCurrentIndex((prevIndex) =>
            prevIndex === 0
                ? Math.max(0, atarResults.length - resultsPerPage)
                : Math.max(0, prevIndex - resultsPerPage)
        );
    };
    ...
    const currentResults = atarResults.slice(
        currentIndex,
    ...
    return (
        <section className="h-auto w-full bg-primary py-16 max-md:py-6">
            <div className="container-responsive mx-auto">
                <div className="flex flex-col items-center justify-center h-full max-md:flex-col">
                    <div className="flex flex-col items-center justify-center bg-white rounded-lg p-12 max-w-6xl mx-auto max-md:p-6">
                        <div className="mb-8">
                            <ScrollAnimateText
                                as="h1"
                                className="text-4xl font-bold text-center text-black max-md:text-3xl"
                            >
                                Our Students' Outstanding ATAR Results
                            </ScrollAnimateText>
                            <ScrollAnimateText
                                as="p"
                                className="text-lg text-center text-black mt-2"
                            >
                                ...
                                <AnimatePresence mode="wait">
                                    ...
                                    >
                                        {currentResults.map((result, index) => (
                                            ...
                                            >
                                                <div className="text-4xl mb-2 max-md:text-2xl">
                                                    🎓
                                                </div>
                                                <AnimatedScore
                                                    score={result.score}
                                                ...
                                                />
                                                <p className="text-lg font-medium mb-1 max-md:text-base">
                                                    {result.name}
                                                </p>
                                                <p className="text-sm text-center max-md:text-sm">
                                                    {result.school}
                                                </p>
                                            </motion.div>
                                        ))}
                        ...
                        <div className="flex space-x-2 mt-6">
                            {Array.from(
                                {
                                    length: Math.ceil(
                                        atarResults.length / resultsPerPage
                                    ),
                                },
                                (_, i) => (
                                    <button
